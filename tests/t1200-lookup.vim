...
call vimtap#Is(MarkMarkup#Lookup(g:markList, 'myformat'), ['1: \<foo\>', '2: animals', '3: \<you\>\|\<me\>', '5: ^EOF$'], 'lookup for myformat')
call vimtap#Is(MarkMarkup#Lookup(g:markList, ''), ['1: \<foo\>', '2: animals', '3: \<you\>\|\<me\>', '5: ^EOF$'], 'lookup for sole myformat')
...
call vimtap#Is(MarkMarkup#Lookup(g:markList, 'myformat'), ['1: \<foo\>', '2: animals', '3: \<you\>\|\<me\>', '5: ^EOF$'], 'lookup for myformat from multiple')
